<div class="modal fade" id="CrearUnidadNegocio" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                {{-- formulario --}}
                <form action="{{ route('unidad_negocio.create') }}" method="POST" name="form-data"
