<div class="modal fade" id="CrearCampaña" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                {{-- formulario --}}
                <form action="{{ route('campaña.create') }}" method="POST" name="form-data"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control" id="CAM_CODE" name="CAM_CODE" required
                            pattern="[0-9]+">
